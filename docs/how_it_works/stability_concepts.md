...
When fees are removed, transactions are considered “non-financial” and not subject to regulatory ambiguity. These transactions are part of an external private mempool whose details are explained [**here**](/how_it_works/architecture#zero-gas-transaction-zgt)
